import type { TemplateState } from "./FormTemplateProcessEngine";
import { LoopVariableScope } from "src/utils/LoopVariableScope";

export default class {

    static compile(text: string, state: TemplateState) {
    ...
    private static evaluateExpression(expr: string, state: TemplateState): string {
