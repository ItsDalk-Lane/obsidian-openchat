...
import type { ChatSession, ChatState, MultiModelMode, LayoutMode } from '../types/chat';
...
export class ChatSessionManager {
	...
	constructor(
		...
		this.historyService = new HistoryService(app, getChatHistoryPath(aiDataFolder));
	}
	...
	private readPersistedLayoutMode(): LayoutMode | null {
		try {
			const raw = window.localStorage.getItem('openchat-layout-mode');
