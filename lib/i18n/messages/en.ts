...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "layout.resizeHint": "drag or hold Shift and use arrow keys",
    "layout.resizeSidebar": "Resize sidebar",
    "layout.resizeFilePanel": "Resize file panel",
    "directoryPicker.noDrives": "No drives found",
    "sidebar.projectUnread": "Unread activity",
    "sidebar.projectRunning": "Agent running",
    ...
    "sidebar.defaultDirectoryFailed": "Failed to resolve the default directory.",
    ...
    "directoryPicker.selectNamedFolder": "Select \"{name}\"",
    "directoryPicker.place.home": "Home",
    "directoryPicker.place.desktop": "Desktop",
    "directoryPicker.place.documents": "Documents",
    "directoryPicker.place.downloads": "Downloads",
    "directoryPicker.recentProjects": "Recent projects",
    "directoryPicker.editPath": "Edit path",
    "directoryPicker.filterPlaceholder": "Filter…",
    "directoryPicker.showHidden": "Show hidden",
    "directoryPicker.newFolder": "New folder",
    "directoryPicker.newFolderPlaceholder": "Folder name",
    "directoryPicker.enterFolder": "Open folder",
    "directoryPicker.nativeUnavailable": "Native directory picker is not available in this environment.",
    "directoryPicker.nativeFailed": "Failed to open native directory picker.",
    "workspaceConfig.title": "Advanced",
    "workspaceConfig.description": "Advanced workspace settings.",
    "workspaceConfig.defaultDirectoryLabel": "Default workspace directory",
    "workspaceConfig.defaultDirectoryHint": "Choose where \"Use default directory\" points.",
    "workspaceConfig.dailyTitle": "Daily temporary directory",
    "workspaceConfig.dailyHint": "Use ~/pi-cwd-<date> (default behavior)",
    "workspaceConfig.fixedTitle": "Fixed directory",
    "workspaceConfig.fixedHint": "Always use the same folder",
    "workspaceConfig.pathPlaceholder": "~/Code or /path/to/workspace",
    "workspaceConfig.browse": "Browse...",
    "workspaceConfig.save": "Save",
    "workspaceConfig.saving": "Saving...",
    "workspaceConfig.pathRequired": "Please enter a directory path.",
    ...
    "sidebar.deleteBranchTitle": "Delete session with branches?",
    "sidebar.deleteBranchBody": "\"{title}\" has {count} branch session(s). Deleting only this session keeps the branches and re-attaches them to its parent; you can also delete it together with all branch sessions.",
    "sidebar.deleteOnlyThis": "Delete only this session",
    "sidebar.deleteWithBranches": "Delete with {count} branch session(s)",
    "sidebar.deleteProject": "Delete all sessions for this path",
    "sidebar.deleteProjectConfirm": "Delete all {count} sessions for this path?",
    "sidebar.deleteProjectNote": "Only session records are deleted — project files on disk are kept.",
    ...
    "files.docxPreview": "DOCX preview",
    ...
    "chat.filesWritten": "Files written",
    ...
    "extension.mcp.enabledOne": "🔌 MCP: {count} server enabled",
    "extension.mcp.enabledMany": "🔌 MCP: {count} servers enabled",
    "extension.mcp.connectedSuffix": " ({count} connected)",
    "extension.mcp.disabledSuffix": " ({count} disabled)",
    "extension.mcp.connectingMany": "🔌 MCP: connecting to {count} servers...",
    "extension.mcp.connectingOne": "🔌 MCP: connecting to {name}...",
    "extension.mcp.authenticating": "Authenticating {name}...",
    "chat.shell": "Shell",
    ...
    "i18n.providerModels": "Models",
    "i18n.visibilityToggleHint": "Check the models to show in the chat model menu; uncheck to hide.",
    "i18n.apply": "Apply",
    "i18n.clearAllRestrictions": "Clear restrictions (show everything)",
    "i18n.newModelShort": "model",
    "i18n.fetchLatestModels": "Fetch latest models",
    "i18n.fetchingModels": "Fetching…",
    "i18n.fetchModelsNotice": "Fetch failed",
