export const zhTwPart4 = {
	...
	system_prompt_feature_selection_toolbar_desc: "管理顯示在劃詞工具列中的快捷操作，呼叫模型時支援注入功能級系統提示詞",
	// 操作管理
	...
	quick_action_edit_use_default_system_prompt: "使用功能系統提示詞",
	quick_action_edit_use_default_system_prompt_hint: "啟用後將使用快捷操作設定中配置的系統提示詞，停用則僅使用自訂提示詞內容",
	// Quick Action 系統提示詞設定
	quick_actions_system_prompt_label: "系統提示詞",
	quick_actions_system_prompt_edit_btn: "編輯",
	quick_actions_system_prompt_modal_title: "快捷操作系統提示詞",
	quick_actions_system_prompt_placeholder: "輸入快捷操作的系統提示詞內容（留空則不注入）…",
	...
	multi_model_compare_concurrency_notice: "已選擇 {count} 個模型。系統最多會並發 {max} 個請求",
	...
	chat_input_selector_type_file: "檔案",
	chat_input_selector_type_folder: "資料夾",
	chat_input_selector_type_image: "圖片",
	chat_input_selector_type_active: "Active",
	chat_mention_active: "Active",
	chat_mention_action_template_name: "提示模板",
	chat_mention_action_template_desc: "打開提示模板列表並套用到目前聊天",
	chat_mention_action_upload_file_name: "上傳檔案",
	chat_mention_action_upload_file_desc: "搜尋並附加檔案或資料夾",
	chat_mention_action_upload_image_name: "上傳圖片",
	chat_mention_action_upload_image_desc: "選擇圖片並加入為聊天附件",
	chat_mention_no_match: "未找到匹配的提示模板、資料夾或檔案",
} as const;
