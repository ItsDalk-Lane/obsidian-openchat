...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "session.cost": "费用",
    "session.context": "上下文",
    "layout.resizeHint": "拖动或按住 Shift 使用方向键",
    "layout.resizeSidebar": "调整侧栏宽度",
    "layout.resizeFilePanel": "调整文件面板宽度",
    "directoryPicker.noDrives": "未找到可用驱动器",
    "sidebar.projectUnread": "有未读活动",
    "sidebar.projectRunning": "Agent 运行中",
    ...
    "sidebar.defaultDirectoryFailed": "获取默认目录失败。",
    ...
    "directoryPicker.selectNamedFolder": "选择“{name}”",
    "directoryPicker.place.home": "主目录",
    "directoryPicker.place.desktop": "桌面",
    "directoryPicker.place.documents": "文稿",
    "directoryPicker.place.downloads": "下载",
    "directoryPicker.recentProjects": "最近项目",
    "directoryPicker.editPath": "编辑路径",
    "directoryPicker.filterPlaceholder": "过滤…",
    "directoryPicker.showHidden": "显示隐藏",
    "directoryPicker.newFolder": "新建文件夹",
    "directoryPicker.newFolderPlaceholder": "文件夹名称",
    "directoryPicker.enterFolder": "进入目录",
    "directoryPicker.nativeUnavailable": "当前环境不支持系统目录选择器。",
    "directoryPicker.nativeFailed": "打开系统目录选择器失败。",
    "workspaceConfig.title": "高级",
    "workspaceConfig.description": "高级工作区设置。",
    "workspaceConfig.defaultDirectoryLabel": "默认工作目录",
    "workspaceConfig.defaultDirectoryHint": "设置“使用默认目录”按钮指向的位置。",
    "workspaceConfig.dailyTitle": "每日临时目录",
    "workspaceConfig.dailyHint": "使用 ~/pi-cwd-<date>（默认行为）",
    "workspaceConfig.fixedTitle": "固定目录",
    "workspaceConfig.fixedHint": "始终使用同一个目录",
    "workspaceConfig.pathPlaceholder": "~/Code 或 /path/to/workspace",
    "workspaceConfig.browse": "浏览…",
    "workspaceConfig.save": "保存",
    "workspaceConfig.saving": "保存中…",
    "workspaceConfig.pathRequired": "请输入目录路径。",
    ...
    "sidebar.deleteBranchTitle": "删除含分支会话的主会话？",
    "sidebar.deleteBranchBody": "「{title}」有 {count} 个分支会话。仅删除此会话时，分支会话会保留并上移至其父级；也可以将其与所有分支会话一起删除。",
    "sidebar.deleteOnlyThis": "仅删除此会话",
    "sidebar.deleteWithBranches": "连同 {count} 个分支会话一起删除",
    "sidebar.deleteProject": "删除此路径的全部会话",
    "sidebar.deleteProjectConfirm": "删除此路径的全部 {count} 个会话？",
    "sidebar.deleteProjectNote": "仅删除会话记录，不删除磁盘上的项目文件。",
    ...
    "files.live": "实时",
    "files.static": "静态",
    "files.imageLoadFailed": "加载图片失败",
    "files.audioLoadFailed": "加载音频失败",
    "files.docxPreview": "DOCX 预览",
    ...
    "chat.noAvailableModels": "无可用模型",
    "chat.moreControls": "更多控件",
    "chat.collapseControls": "收起控件",
    "extension.mcp.enabledOne": "🔌 MCP：{count} 个服务器已启用",
    "extension.mcp.enabledMany": "🔌 MCP：{count} 个服务器已启用",
    "extension.mcp.connectedSuffix": "（{count} 个已连接）",
    "extension.mcp.disabledSuffix": "（{count} 个已禁用）",
    "extension.mcp.connectingMany": "🔌 MCP：正在连接 {count} 个服务器…",
    "extension.mcp.connectingOne": "🔌 MCP：正在连接 {name}…",
    "extension.mcp.authenticating": "正在认证 {name}…",
    "chat.shell": "Shell",
    ...
    "i18n.providerModels": "模型列表",
    "i18n.visibilityToggleHint": "勾选要显示在聊天模型菜单中的模型，取消勾选即隐藏。",
    "i18n.apply": "应用",
    "i18n.clearAllRestrictions": "解除所有限制（全部显示）",
    "i18n.newModelShort": "模型",
    "i18n.fetchLatestModels": "拉取最新模型",
    "i18n.fetchingModels": "正在拉取…",
    "i18n.fetchModelsNotice": "拉取失败",
