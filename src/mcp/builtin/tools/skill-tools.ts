import type { SkillToolInput } from 'src/skills/types';
import { loadSkillContent, formatSkillToolResult } from 'src/skills/skillContent';
import { z } from 'zod';
import type { SkillScannerService } from 'src/skills/SkillScannerService';
